...
export class Operation {
   ...
   * @param {string} opts.startingBalance - Amount in RIA the account should be funded for. Must be greater
   ...
   * destination account, optionally through a path. RIA payments create the destination
